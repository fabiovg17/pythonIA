...
'''
Crea un método de instancia lanzar_flecha() que reste en -1 la cantidad de flechas que tiene 
una instancia de Personaje, que cuenta con un atributo de instancia de tipo número, 
...
flechas = 7
harry = Personaje(flechas)
print(harry.lanzar_flecha())