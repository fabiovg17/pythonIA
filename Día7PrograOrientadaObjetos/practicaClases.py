...
Crea una instancia de Casa, llamada casa_blanca, de color "blanco" y 
cantidad de pisos igual a 4.
'''
...
print(harry_potter.especie)  # Humano
print(harry_potter.magico)  # True
print(harry_potter.edad)  # 17
print(Personaje.real)  # False
